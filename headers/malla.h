...
public:
    ...
    Malla_RR(std::vector<Vector> vertices, std::vector<Triangle> triangulos, PropiedadesObjeto prop);
...
Malla_RR::Malla_RR(std::vector<Vector> vertices, std::vector<Triangle> triangulos, PropiedadesObjeto prop)
    : Objeto_RR(prop), vertices(vertices), triangulos(triangulos) {}
